...
const ALL: Array = [
	...
	{"name": "Heal",            "desc": "Restores HP to yourself.",                         "mana_cost": 25.0, "cast_time": 1.0, "cooldown": 6.0,  "base_damage": 0.0,  "damage_type": "NONE",      "target_type": "ALLY",  "heal_amount": 40.0, "classes": ["Magician"]},
	...
	# ── Cleric ────────────────────────────────────────────────────────────────
	{"name": "Healing Light",   "desc": "Calls down a beam of holy light to mend wounds.",  "mana_cost": 35.0, "cast_time": 1.2, "cooldown": 5.0,  "base_damage": 0.0,  "damage_type": "HOLY",  "target_type": "ALLY",  "heal_amount": 60.0,  "classes": ["Cleric"]},
	{"name": "Greater Heal",    "desc": "A powerful prayer that restores a great amount of health.", "mana_cost": 55.0, "cast_time": 2.5, "cooldown": 12.0, "base_damage": 0.0, "damage_type": "HOLY", "target_type": "ALLY", "heal_amount": 120.0, "min_level": 8, "classes": ["Cleric"]},
	...
	{"name": "Bless",           "desc": "Invokes a divine blessing that sharpens the mind and strengthens will.", "mana_cost": 20.0, "cast_time": 1.0, "cooldown": 0.0, "base_damage": 0.0, "damage_type": "HOLY", "target_type": "ALLY", "heal_amount": 0.0, "wis_buff": 5, "primary_stat_buff_duration": 600.0, "min_level": 4, "classes": ["Cleric", "Paladin"]},
	{"name": "Valor",           "desc": "Fills the target with righteous courage, bolstering strength and fortitude.", "mana_cost": 35.0, "cast_time": 2.0, "cooldown": 0.0, "base_damage": 0.0, "damage_type": "HOLY", "target_type": "ALLY", "heal_amount": 0.0, "str_buff": 10, "max_hp_buff": 50.0, "primary_stat_buff_duration": 600.0, "min_level": 10, "classes": ["Cleric"]},

	# ── Druid ─────────────────────────────────────────────────────────────────
	{"name": "Regrowth",        "desc": "Wraps the caster in natural energies that mend wounds over time.", "mana_cost": 25.0, "cast_time": 1.0, "cooldown": 6.0,  "base_damage": 0.0,  "damage_type": "NATURE", "target_type": "ALLY",  "heal_amount": 0.0, "hot_hps": 5.0, "hot_duration": 18.0, "classes": ["Druid"]},
	...
	{"name": "Thorns",          "desc": "Surrounds you with a barrier of natural energy. Attackers take 8 nature damage each time they strike you.", "mana_cost": 25.0, "cast_time": 1.5, "cooldown": 0.0, "base_damage": 0.0, "damage_type": "NATURE", "target_type": "ALLY", "heal_amount": 0.0, "damage_shield_amount": 8.0, "damage_shield_duration": 600.0, "min_level": 10, "classes": ["Druid"]},
	...
	# ── Shaman ────────────────────────────────────────────────────────────────
	{"name": "Healing Wave",    "desc": "Calls upon ancestor spirits to mend wounds over time.", "mana_cost": 30.0, "cast_time": 1.0, "cooldown": 6.0,  "base_damage": 0.0,  "damage_type": "SPIRIT", "target_type": "ALLY",  "heal_amount": 15.0, "hot_hps": 4.0, "hot_duration": 18.0, "min_level": 4, "classes": ["Shaman"]},
	{"name": "Mending",         "desc": "A quick spiritual mend for minor wounds.",          "mana_cost": 15.0, "cast_time": 0.5, "cooldown": 4.0,  "base_damage": 0.0,  "damage_type": "SPIRIT", "target_type": "ALLY",  "heal_amount": 25.0, "classes": ["Shaman"]},
	...
	{"name": "Spirit of the Bear",   "desc": "Calls upon the spirit of the bear, granting great strength and endurance.", "mana_cost": 30.0, "cast_time": 2.0, "cooldown": 0.0, "base_damage": 0.0, "damage_type": "SPIRIT", "target_type": "ALLY", "heal_amount": 0.0, "str_buff": 10, "con_buff": 5, "primary_stat_buff_duration": 600.0, "min_level": 10, "classes": ["Shaman"]},
	{"name": "Gift of Insight",      "desc": "Ancestor spirits illuminate the mind, sharpening wisdom and arcane understanding.", "mana_cost": 30.0, "cast_time": 2.0, "cooldown": 0.0, "base_damage": 0.0, "damage_type": "SPIRIT", "target_type": "ALLY", "heal_amount": 0.0, "wis_buff": 8, "int_buff": 5, "primary_stat_buff_duration": 600.0, "min_level": 14, "classes": ["Shaman"]},
	...
	# ── Paladin ───────────────────────────────────────────────────────────────
	{"name": "Lay on Hands",    "desc": "Channels pure divine energy to restore a massive amount of health.", "mana_cost": 45.0, "cast_time": 2.0, "cooldown": 15.0, "base_damage": 0.0, "damage_type": "HOLY", "target_type": "ALLY", "heal_amount": 80.0, "min_level": 6, "classes": ["Paladin"]},
	{"name": "Crusader's Mend", "desc": "A quick blessing that mends wounds mid-combat.",    "mana_cost": 20.0, "cast_time": 0.5, "cooldown": 5.0,  "base_damage": 0.0,  "damage_type": "HOLY", "target_type": "ALLY",  "heal_amount": 35.0, "classes": ["Paladin"]},
	...
	{"name": "Strength",           "desc": "Infuses the target with arcane force, greatly augmenting physical power.", "mana_cost": 25.0, "cast_time": 1.5, "cooldown": 0.0, "base_damage": 0.0, "damage_type": "ARCANE", "target_type": "ALLY", "heal_amount": 0.0, "str_buff": 12, "primary_stat_buff_duration": 600.0, "min_level": 8, "classes": ["Enchanter"]},
	{"name": "Brilliance",         "desc": "Heightens arcane acuity, sharpening both intellect and intuition.", "mana_cost": 25.0, "cast_time": 1.5, "cooldown": 0.0, "base_damage": 0.0, "damage_type": "ARCANE", "target_type": "ALLY", "heal_amount": 0.0, "int_buff": 10, "wis_buff": 5, "primary_stat_buff_duration": 600.0, "min_level": 10, "classes": ["Enchanter"]},
	...
	{"name": "Battle Hymn",     "desc": "A rousing song that patches wounds and steadies the spirit.", "mana_cost": 20.0, "cast_time": 0.5, "cooldown": 6.0, "base_damage": 0.0,  "damage_type": "ARCANE", "target_type": "ALLY",  "heal_amount": 30.0, "classes": ["Bard"]},
	...
	{"name": "Nature's Cure",   "desc": "Draws on forest magic to close wounds and restore vitality.", "mana_cost": 20.0, "cast_time": 0.5, "cooldown": 5.0, "base_damage": 0.0, "damage_type": "NATURE", "target_type": "ALLY",  "heal_amount": 35.0, "classes": ["Ranger"]},
	...
	{"name": "Rite of Warding", "desc": "A hunter's prayer that seals wounds and steels the nerves.",                "mana_cost": 18.0, "cast_time": 0.5, "cooldown": 5.0,  "base_damage": 0.0,  "damage_type": "HOLY",  "target_type": "ALLY",  "heal_amount": 30.0, "classes": ["Witch Hunter"]},
	...
	# ── Beast Master ──────────────────────────────────────────────────────────
	{"name": "Spirit Mend",   "desc": "Calls on a thread of spirit energy to quickly close wounds.",                                        "mana_cost": 15.0, "cast_time": 0.5, "cooldown":  4.0, "base_damage":  0.0, "damage_type": "SPIRIT", "target_type": "ALLY",     "heal_amount": 25.0, "classes": ["Beast Master"]},
	...
	# ── Enchanter (new) ──────────────────────────────────────────────────────────
	{"name": "Clarity", "desc": "Focuses the target's mind, generating a rapid flow of mana over time.",             "mana_cost": 30.0, "cast_time": 1.0, "cooldown": 5.0, "base_damage": 0.0, "damage_type": "ARCANE", "target_type": "ALLY", "heal_amount": 0.0, "mp_regen_hps": 8.0, "mp_regen_duration": 36.0, "min_level": 14, "classes": ["Enchanter"]},
	...
	{"name": "Haste",   "desc": "Quickens the target's hands, reducing melee attack delay by 50% for 30 seconds.",  "mana_cost": 40.0, "cast_time": 1.5, "cooldown": 5.0, "base_damage": 0.0, "damage_type": "ARCANE", "target_type": "ALLY", "heal_amount": 0.0, "haste_amount": 0.5, "haste_duration": 30.0, "min_level": 16, "classes": ["Enchanter"]},

	# ── Druid / Shaman (new) ──────────────────────────────────────────────────────
	{"name": "Spirit of Wolf", "desc": "Calls the spirit of the wolf to guide your steps, increasing movement speed by 40%.", "mana_cost": 25.0, "cast_time": 1.0, "cooldown": 5.0, "base_damage": 0.0, "damage_type": "SPIRIT", "target_type": "ALLY", "heal_amount": 0.0, "move_speed_mult": 1.4, "move_speed_duration": 60.0, "min_level": 12, "classes": ["Druid", "Shaman"]},
	...
	# ── Cleric ranks ──────────────────────────────────────────────────────────────
	{"name": "Healing Light Rk. II",  "desc": "A stronger beam of holy light that mends deep wounds.",  "mana_cost": 42.0, "cast_time": 1.2, "cooldown":  5.0, "base_damage": 0.0, "damage_type": "HOLY", "target_type": "ALLY", "heal_amount":  85.0, "min_level":  8, "rank": 2, "base_name": "Healing Light", "classes": ["Cleric"]},
	{"name": "Healing Light Rk. III", "desc": "A radiant pillar of holy power that restores greatly.",  "mana_cost": 50.0, "cast_time": 1.2, "cooldown":  5.0, "base_damage": 0.0, "damage_type": "HOLY", "target_type": "ALLY", "heal_amount": 115.0, "min_level": 16, "rank": 3, "base_name": "Healing Light", "classes": ["Cleric"]},
	...
	{"name": "Regrowth Rk. II","desc": "A deeper weave of natural energies that mends wounds faster.",  "mana_cost": 30.0, "cast_time": 1.0, "cooldown": 6.0, "base_damage":  0.0, "damage_type": "NATURE", "target_type": "ALLY",  "heal_amount": 0.0, "hot_hps": 7.0, "hot_duration": 18.0, "min_level": 8, "rank": 2, "base_name": "Regrowth", "classes": ["Druid"]},
	...
	{"name": "Mending Rk. II",      "desc": "A stronger spiritual mend for moderate wounds.",          "mana_cost": 20.0, "cast_time": 0.5, "cooldown": 4.0, "base_damage":  0.0, "damage_type": "SPIRIT", "target_type": "ALLY",  "heal_amount": 38.0, "min_level":  6, "rank": 2, "base_name": "Mending",     "classes": ["Shaman"]},
	...
	{"name": "Crusader's Mend Rk. II","desc": "A more potent quick blessing that mends wounds.",       "mana_cost": 25.0, "cast_time": 0.5, "cooldown": 5.0, "base_damage":  0.0, "damage_type": "HOLY",  "target_type": "ALLY",  "heal_amount": 50.0, "min_level":  8, "rank": 2, "base_name": "Crusader's Mend", "classes": ["Paladin"]},
	...
	{"name": "Battle Hymn Rk. II","desc": "A more stirring song that patches wounds more quickly.",   "mana_cost": 25.0, "cast_time": 0.5, "cooldown": 6.0, "base_damage":  0.0, "damage_type": "ARCANE", "target_type": "ALLY",  "heal_amount": 45.0, "min_level":  8, "rank": 2, "base_name": "Battle Hymn", "classes": ["Bard"]},
	...
	# ── Beast Master ranks ────────────────────────────────────────────────────────
	{"name": "Spirit Mend Rk. II",  "desc": "A more potent thread of spirit energy to close wounds.", "mana_cost": 20.0, "cast_time": 0.5, "cooldown":  4.0, "base_damage":  0.0, "damage_type": "SPIRIT", "target_type": "ALLY",  "heal_amount": 38.0, "min_level":  8, "rank": 2, "base_name": "Spirit Mend",  "classes": ["Beast Master"]},
