...
const ALL: Array = [
	...
	{"name": "Hide",             "desc": "Duck into the shadows. Enemies will not detect you. Breaks on attacking.", "cooldown": 10.0, "stamina_cost": 15.0, "damage_multiplier": 0.0, "effect_type": "STEALTH", "stealth_duration": 30.0, "classes": ["Rogue"]},
	{"name": "Shield Bash",      "desc": "Stuns and damages with your shield.",                   "cooldown": 8.0,  "stamina_cost": 15.0, "damage_multiplier": 1.2, "effect_type": "STUN", "stun_duration": 3.0, "classes": ["Warrior"]},
	...
	{"name": "Aimed Shot",       "desc": "A carefully aimed shot that deals massive damage.",              "cooldown": 20.0, "stamina_cost": 35.0, "damage_multiplier": 3.0, "classes": ["Ranger"]},
	{"name": "Rapid Shot",       "desc": "Three quick shots in rapid succession (combined damage).",       "cooldown": 12.0, "stamina_cost": 25.0, "damage_multiplier": 2.1, "classes": ["Ranger"]},
	{"name": "Dual Flurry",      "desc": "A simultaneous strike with both weapons.",                       "cooldown": 10.0, "stamina_cost": 18.0, "damage_multiplier": 1.3, "classes": ["Ranger"]},
	...
	{"name": "Feign Death",      "desc": "Drop to the ground, appearing dead. Enemies lose interest. Has a chance to fail.", "cooldown": 60.0, "stamina_cost": 20.0, "damage_multiplier": 0.0, "effect_type": "FEIGN_DEATH", "classes": ["Monk"]},
	...
	{"name": "Exploit Weakness",  "desc": "Targets a critical vulnerability, dealing greatly increased damage.", "cooldown": 15.0, "stamina_cost": 20.0, "damage_multiplier": 1.8, "classes": ["Witch Hunter"]},
	{"name": "Truesight Strike",  "desc": "A strike guided by magical sight that ignores evasion and stealth.",  "cooldown":  8.0, "stamina_cost": 10.0, "damage_multiplier": 1.2, "effect_type": "TRUESIGHT", "classes": ["Witch Hunter"]},
