...
const REBINDABLE_ACTIONS: Array[Dictionary] = [
	...
	{id = "target_group_1",    label = "Target Group 1",    category = "Combat",   default_key = KEY_F2},
	{id = "target_group_2",    label = "Target Group 2",    category = "Combat",   default_key = KEY_F3},
	{id = "target_group_3",    label = "Target Group 3",    category = "Combat",   default_key = KEY_F4},
	{id = "target_group_4",    label = "Target Group 4",    category = "Combat",   default_key = KEY_F5},
	{id = "target_group_5",    label = "Target Group 5",    category = "Combat",   default_key = KEY_F6},
	{id = "toggle_auto_attack",label = "Toggle Auto Attack",category = "Combat",   default_key = KEY_Q},
	{id = "toggle_mouselook",  label = "Toggle Mouselook",  category = "Camera",   default_key = KEY_F12},
	{id = "cycle_view",        label = "Cycle Camera View", category = "Camera",   default_key = KEY_F9},
	...
	{id = "toggle_autorun",    label = "Autorun",           category = "Movement", default_key = KEY_BACKSLASH},
